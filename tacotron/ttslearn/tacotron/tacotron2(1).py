...
class Tacotron2(nn.Module):
    ...
    def forward(self, seq, in_lens, energy_feats, energy_lens, pitch_feats, pitch_lens, ex_feats, ex_lens, decoder_targets):
        """Forward step
        ...
        energy_outs = self.encoder3(energy_feats, energy_lens)
        pitch_outs = self.encoder4(pitch_feats, pitch_lens)
