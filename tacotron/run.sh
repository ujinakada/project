...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    xrun python train_tacotron.py model=$acoustic_model tqdm=$tqdm \
        ...
        data.train.energy_dir=dump2/$train_set/energy/ \
        data.train.pitch_dir=dump2/$train_set/pitch/ \
        data.train.ex_dir=dump2/$train_set/ex/ \
        ...
        data.dev.energy_dir=dump2/$dev_set/energy/ \
        data.dev.pitch_dir=dump2/$dev_set/pitch/ \
        data.dev.ex_dir=dump2/$dev_set/ex/ \
